...
const App = () => {
  ...
  return (
    <>
      ...
      <main className="bg-[#464646] h-[90vh] w-full flex justify-center items-center">
        <div className="w-1/2">
          <div className={`relative w-[780px]  `}>
            ...
            <form
              action=""
              className="bg-transparent px-8 py-4 flex items-center gap-3 rounded-full  w-full relative z-10 text-gray-400"
            >
              <FiSearch className="w-5 h-5" />
              <input
                type="text"
                placeholder="AI Engineer with score above 95"
                className="w-full bg-transparent border-none outline-none text-lg placeholder:text-gray-400 font-normal   text-gray-400"
              />
            </form>
          </div>
        </div>
